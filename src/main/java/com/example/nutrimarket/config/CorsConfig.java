package com.example.nutrimarket.config;
...
import static com.example.nutrimarket.constant.Constant.X_REQUESTED_WITH;
...
public class CorsConfig {
    ...
    public CorsFilter corsFilter() {
        ...
        corsConfiguration.setAllowedOrigins(List.of("http://localhost:3000", "http://localhost:6000", "http://localhost:5173"));
